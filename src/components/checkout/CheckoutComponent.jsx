                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-content text-center">
                                    <div className="section-heading">
                                        <h2 className="sec__title text-white">Checkout</h2>
                                    </div>
                                                    ...
                                                    <div className="input-box">
                                                        <div className="form-group mb-0">
                                                            <div className="custom-checkbox mb-0">
                                                                ...
                                                                <label htmlFor="receiveChb">I want to receive Trizen's promotional offers
                                                                    in the future</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="card-item shadow-none radius-none mb-0">
                                        ...
                                        <div className="card-body p-0">
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a href="room-details.html" className="btn ms-1"><i className="la la-edit" data-bs-toggle="tooltip" data-placement="top" title="Edit" /></a>
                                                </div>
                                            </div>
                                            <div className="section-block" />
                                            <ul className="list-items list-items-2 list-items-flush py-2">
                                                <li className="font-size-15">
                                                    <span className="w-auto d-block mb-n1"><i className="la la-calendar me-1 font-size-17" />From</span>12 May 2020 7:40am
                                                </li>
                                                <li className="font-size-15">
                                                    <span className="w-auto d-block mb-n1"><i className="la la-calendar me-1 font-size-17" />To</span>16 May 2020 8:40am
                                                </li>
                                            </ul>
