...
const TourBookingComponent = () => {
    useEffect(() => {
        // Initialize Select2 for selects converted from the template
        ...
        return () => {
            // Destroy Select2 instances on unmount to avoid leaks
            try {
                if (typeof window !== 'undefined' && window.$ && window.$.fn && window.$.fn.select2) {
                    window.$('.select-contain-select').select2('destroy')
                }
            } catch {
                // ignore
            }
                            ...
                            <div className="col-lg-6">
                                <div className="breadcrumb-content">
                                    <div className="section-heading">
                                        <h2 className="sec__title text-white">Tour Booking</h2>
                                    </div>
                                </div>
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="input-box">
                                                        <div className="custom-checkbox mb-0">
                                                            <input type="checkbox" className="form-check-input" id="receiveChb" />
                                                            <label htmlFor="receiveChb">I want to receive TravelVela's promotional offers
                                                                in the future</label>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="section-tab check-mark-tab text-center pb-4">
                                        <ul className="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                            <li className="nav-item">
                                                <a className="nav-link active" id="credit-card-tab" data-bs-toggle="tab" href="#credit-card" role="tab" aria-controls="credit-card" aria-selected="false">
                                            ...
                                            <li className="nav-item">
                                                <a className="nav-link" id="paypal-tab" data-bs-toggle="tab" href="#paypal" role="tab" aria-controls="paypal" aria-selected="true">
                                                    <i className="la la-check icon-element" />
                                            ...
                                            <li className="nav-item">
                                                <a className="nav-link" id="payoneer-tab" data-bs-toggle="tab" href="#payoneer" role="tab" aria-controls="payoneer" aria-selected="true">
                                                    <i className="la la-check icon-element" />
                                    ...
                                    <div className="card-item shadow-none radius-none mb-0">
                                        ...
                                        <div className="card-body p-0">
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a href="tour-details.html" className="btn ms-1"><i className="la la-edit" data-bs-toggle="tooltip" data-placement="top" title="Edit" /></a>
                                                </div>
                                            </div>
                                            ...
                                            <ul className="list-items list-items-2 list-items-flush py-2">
                                                <li className="font-size-15">
                                                    <span className="w-auto d-block mb-n1"><i className="la la-calendar me-1 text-black font-size-17" />Check in</span>12 May 2020 7:40am
                                                </li>
                                                <li className="font-size-15">
                                                    <span className="w-auto d-block mb-n1"><i className="la la-calendar me-1 text-black font-size-17" />Check out</span>15 May 2020 7:40am
                                                </li>
                                                <li className="font-size-15">
                                                    <span className="w-auto d-block mb-n1"><i className="la la-clock-o me-1 text-black font-size-17" />Duration</span>3 days 3 hours
                                                </li>
                                                <li className="font-size-15">
                                                    <span className="w-auto d-block mb-n1"><i className="la la-map-marker me-1 text-black font-size-17" />Location</span>124 E Huron St, New york
                                                </li>
                                            </ul>
