...
export default function FaqComponent() {
    return (
        <div>
                                ...
                                <div className="breadcrumb-content text-center">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 mx-auto">
                                            ...
                                            <div className="trending-search font-size-14 pt-2">
                                                <span className="text-white font-weight-bold me-1">Try:</span>
            ...
            {/* start faq area */}
            <section className="faq-area padding-top-100px padding-bottom-70px text-center">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
                                        <g>
                                            <g>
                                    ...
                                    <span className="d-block info__title">Getting Started</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve">
                                        <g>
                                            <g>
                                  ...
                                  C149.049,291.55,147.979,288.98,146.109,287.11z" />
                                    ...
                                    <span className="d-block info__title">Pricing Plans</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" version="1.1" id="Capa_3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.001 512.001" style={{ enableBackground: 'new 0 0 512.001 512.001' }} xmlSpace="preserve">
                                        <g>
                                            <g>
                                  ...
                                  c0-3.312,2.694-6.006,6.006-6.006c3.312,0,6.006,2.694,6.006,6.006C354.816,103.198,352.122,105.893,348.81,105.893z" />
                                    ...
                                    <span className="d-block info__title">Sales Question</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" version="1.1" id="Capa_4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 412.72 412.72" style={{ enableBackground: 'new 0 0 412.72 412.72' }} xmlSpace="preserve">
                                        <g>
                                            <g>
                                  ...
                                  c4.368,0.663,8.447-2.341,9.11-6.709c0.065-0.427,0.095-0.859,0.09-1.291V98.944h19.12L396.64,333.664z" />
                                    ...
                                    <span className="d-block info__title">Usage Guides</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" id="Capa_5" enableBackground="new 0 0 511.996 511.996" viewBox="0 0 511.996 511.996" xmlns="http://www.w3.org/2000/svg">
                                        <g id="XMLID_1609_">
                                            <g id="XMLID_564_">
                                    ...
                                    <span className="d-block info__title">Information</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" version="1.1" id="Capa_6" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 480.1 480.1" style={{ enableBackground: 'new 0 0 480.1 480.1' }} xmlSpace="preserve">
                                        <g>
                                            <g>
                                    ...
                                    <span className="d-block info__title">Transactions</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 507.996 507.996" style={{ enableBackground: 'new 0 0 507.996 507.996' }} xmlSpace="preserve">
                                        <g>
                                            <g>
                                  ...
                                  h-39.9l-218.4-69l4.9-15.6c1.3-4.2,6-6.7,10.3-5.3l343.8,108.5C492.8,196.788,491.9,203.188,491.3,205.288z" />
                                    ...
                                    <span className="d-block info__title">Card</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
                        <div className="col-lg-3 responsive-column">
                            <div className="icon-box faq-icon-box">
                                <a href="#" className="d-block">
                                    <svg className="info-svg" version="1.1" id="Capa_8" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 511.997 511.997" xmlSpace="preserve">
                                        <g>
                                            <g>
                                  ...
                                  C319.133,259.86,315.775,256.502,311.633,256.502z" />
                                    ...
                                    <span className="d-block info__title">Account</span>
                                </a>
                            </div>
                        </div>
                        {/* end col-lg-3 */}
            ...
            {/* start faq area */}
            <section className="faq-area section-bg padding-top-100px padding-bottom-60px">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
